...
<template>
  <button
    ...
    :aria-label="themeStore.resolved === 'dark' ? '切换到浅色模式' : '切换到深色模式'"
  >
    <svg
      v-if="themeStore.resolved === 'dark'"
      xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
      fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
      class="text-orange-400 transition-transform duration-500"
    >
    ...
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
      fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
      class="text-slate-700 transition-transform duration-500"
    >
